...
--  This is a version for the STM32F446x MCU
package Ada.Interrupts.Names is
   ...
   CEC_Interrupt                 : constant Interrupt_ID := 93;

   --  SPDIF_RX global interrupt
   SPDIF_RX_Interrupt            : constant Interrupt_ID := 94;

   --  FMPI2C1 event interrupt
   FMPI2C1_EV_Interrupt          : constant Interrupt_ID := 95;

   --  FMPI2C1 error interrupt
   FMPI2C1_ER_Interrupt          : constant Interrupt_ID := 96;
